// AppController - Controls top-level logic for which views to show at any given time.
import $ from 'jquery';
...
export const AppController = Controller.extend({
  initialize: function() {
  ...
  createMap: function(city) {
    ...
    utils.geocode(city, function(latlng, name, preferMetricUnits) {
      var map = new app.Map({
        name: name,
        center: latlng,
