// Service Window View Component
import { BaseView } from '../../framework/BaseView.js';
import { serviceWindowViewTemplate } from '../../templates/service-window-view.js';

export const ServiceWindowView = BaseView.extend({
  templateString: serviceWindowViewTemplate,
...
if (typeof window !== 'undefined') {
  ...
  window.app.ServiceWindowView = ServiceWindowView;
}
