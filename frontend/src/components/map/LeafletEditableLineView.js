// Leaflet Editable Line View Component
...
export const LeafletEditableLineView = Backbone.View.extend({
  initialize: function() {
  ...
  addMarker: function(latlng, waypointIndex) {
    var color = utils.tweakColor(this.model.get('color'), -30);
...
if (typeof window !== 'undefined') {
  ...
  window.app.LeafletEditableLineView = LeafletEditableLineView;
}
